...
4. **Openly acknowledged struggle.** One memoriam context included a long, publicly
   ...
   person's family.
5. **Most often: silence on cause.** The dominant pattern is omission. The largest
   project memorial page we studied names many causes of death freely (cancer,
   accidents, COVID-19) but attributes no death to suicide, even where an official
   ruling exists in the public record — meaning project memorials alone cannot carry
...
not only internal community health; and the omission norm (5) means prevention research
must not rely on community self-reporting to understand the scale of the problem.

## What the memorial practices teach (de-identified patterns)

1. **Permanent institutional memory.** Project-history memorial chapters, whole
   releases dedicated to a deceased contributor, archived condolence addresses — and,
   as the limit case, one tribute embedded immutably in a public blockchain, impossible
   to take down by construction. OSS memorials are typically *permanent*, in tension
   with the 30–60-day time limit postvention guidance recommends for organization-run
   online memorial pages (norm 7): archival/historical records and active-grief
   memorial pages may need to be treated as different objects.
2. **The omission norm.** See (5) above — partial alignment with safe messaging
   (privacy, no sensationalism), at the cost of the public-health record.
3. **Memorial-by-continuing-the-work.** Annual memorial hackathons continuing the
   person's projects; memoriam posts that end in commitments to change community
   practice. The "focus on the lived life" principle, in OSS dialect.
4. **Parity in practice.** The communities we studied memorialize deaths by suicide
...
3. Beyond the one first-person community analysis we verified, is there peer-reviewed
   ...
   — Wingman-Connect, Sources of Strength, peer-adult network structure — supplies the
   general evidence base; the OSS-specific link is the gap.)
